...
t = TicTacToe.new
p = Player.new("Player name", :x, "Board")
b = Board.new
File.open('ttt_interfaces.txt', 'a') do |file|
  file.write(t.public_methods(false))
  file.write(p.public_methods(false))
  file.write(b.public_methods(false))
end
